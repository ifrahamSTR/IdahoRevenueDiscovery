...
# REPO_ROOT is .../Tools/STRClusterDiscovery/Idaho/webpage; Snowflake/ lives at
# the STRWork root, four levels above REPO_ROOT.
INPUT_CSV = REPO_ROOT.parent.parent.parent.parent / "Snowflake" / "Idaho" / "Iqbal_Idaho_2026-09-16-1857.csv"
...
# ---------------------------------------------------------------------------
# Region-discovery tuning. Re-tune per state (see module docstring).
# ---------------------------------------------------------------------------
REGION_REVENUE_THRESHOLD = 90000  # matches js/config.js CONFIG.defaultThreshold
DBSCAN_EPS_KM = 12
DBSCAN_MIN_SAMPLES = 4
MERGE_KM = 30  # union clusters whose centroids are closer than this
...
# Idaho-specific: dominant-city -> (slug, display name). A cluster is named
...
REGION_LABELS = {
    "Island Park": ("island-park", "Island Park"),
    "Driggs": ("teton-valley", "Teton Valley"),
    "Tetonia": ("teton-valley", "Teton Valley"),
    "Victor": ("teton-valley", "Teton Valley"),
    "Felt": ("teton-valley", "Teton Valley"),
    "Mccall": ("mccall-west-central-mountains", "McCall & the West Central Mountains"),
    "Donnelly": ("mccall-west-central-mountains", "McCall & the West Central Mountains"),
    "Cascade": ("mccall-west-central-mountains", "McCall & the West Central Mountains"),
    "Coeur D Alene": ("coeur-dalene", "Coeur d'Alene"),
    "Hayden": ("coeur-dalene", "Coeur d'Alene"),
    "Post Falls": ("coeur-dalene", "Coeur d'Alene"),
    "Harrison": ("coeur-dalene", "Coeur d'Alene"),
    "Boise": ("boise-foothills-eagle", "Boise Foothills & Eagle"),
    "Meridian": ("boise-foothills-eagle", "Boise Foothills & Eagle"),
    "Eagle": ("boise-foothills-eagle", "Boise Foothills & Eagle"),
    "Ketchum": ("sun-valley-wood-river", "Sun Valley & Wood River Valley"),
    "Sun Valley": ("sun-valley-wood-river", "Sun Valley & Wood River Valley"),
    "Hailey": ("sun-valley-wood-river", "Sun Valley & Wood River Valley"),
    "Sagle": ("sandpoint-pend-oreille", "Sandpoint & Lake Pend Oreille"),
    "Sandpoint": ("sandpoint-pend-oreille", "Sandpoint & Lake Pend Oreille"),
    "Lava Hot Springs": ("lava-hot-springs", "Lava Hot Springs"),
    "Fish Haven": ("bear-lake", "Bear Lake"),
    "Garden Valley": ("garden-valley", "Garden Valley"),
}
